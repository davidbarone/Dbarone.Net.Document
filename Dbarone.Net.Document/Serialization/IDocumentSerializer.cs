...
public interface IDocumentSerializer
{
    ...
    /// </summary>
    /// <param name="document">The instance to serialise.</param>
    /// <param name="schema">Optional document schema.</param>
    /// <param name="textEncoding">The optional text encoding to use.</param>
    /// <returns>Returns a byte array.</returns>
    byte[] Serialize(DocumentValue document, SchemaElement? schema = null, TextEncoding textEncoding = TextEncoding.UTF8);
